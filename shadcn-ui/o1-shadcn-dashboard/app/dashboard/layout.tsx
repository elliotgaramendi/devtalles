...
const links = [
  ...
  { name: "dropdown menu", href: "/dashboard/dropdown-menu" },
  { name: "select", href: "/dashboard/select" },
  { name: "radio group", href: "/dashboard/radio-group" },
  { name: "switch", href: "/dashboard/switch" },
  { name: "forms", href: "/dashboard/forms" },
  { name: "dark mode", href: "/dashboard/dark-mode" }
    ...
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900">
        ...
        >
          ...
          <footer className="bg-white dark:bg-slate-900 md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
