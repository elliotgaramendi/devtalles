    ...
    <div className="flex flex-col items-center max-w-xs bg-gray-900 border border-gray-800 rounded-xl">
      ...
      <div className="flex flex-col gap-4 p-8">
        ...
        <div className="flex justify-around text-center">
          ...
          <div className="flex flex-col">
            <span className="text-lg font-medium text-white">{skills.length}</span>
            <span className="text-xs text-gray-400 tracking-wide">Techs</span>
          </div>
          <div className="flex flex-col">
        ...
        <div className="flex gap-4">
          <button className="flex-1 py-2 bg-sky-400 text-gray-900 rounded-lg font-medium hover:bg-sky-500 transition">
            Follow
          </button>
